...
public class ServerThread extends Thread {
    ...
    private  ClockInformation data = null;
    ...
    public ServerThread(int port) {
        ...
        this.data = new ClockInformation();
    }
    ...
    public synchronized void setData(ClockInformation clockInformation) {
        this.data = clockInformation;
    }

    public synchronized ClockInformation getData() {
        return data;
    }
